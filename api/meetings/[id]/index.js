...
export default async function handler(req, res) {
  ...
  if (req.method === 'GET') {
    return handleGetMeeting(req, res, id);
  }
...
async function handleGetMeeting(req, res, id) {
  try {
    ...
    if (error) {
      if (error.details === 'The resource was not found') {
...
async function handleUpdateMeeting(req, res, id) {
  try {
    ...
    // Delete all existing participants (cascade deletes their literature)
    ...
    // Re-insert participants and literature
    const nestedParticipants = [];
...
async function handleDeleteMeeting(req, res, id) {
  try {
    // Delete the meeting (cascade deletes participants and literature)
